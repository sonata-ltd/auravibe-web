import { SpinnerIcon } from "@/icons/components/spinner";

import css from "./loading.module.less";
import { DoneIcon } from "@/icons/components/check-circle";
...
export const ContentLoadingIndicator = (
	props: ContentLoadingIndicatorProps,
) => {
	return (
		<>
			<div class={css["indicator-wrapper"]} ref={props.ref}>
				<div
					style={`${
						props.spinnerSize
